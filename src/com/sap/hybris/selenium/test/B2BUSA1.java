...
public class B2BUSA1 {
	...
	public String getOS() {		
		String OS;
		return OS = System.getProperty("os.name").toLowerCase().substring(0, 3);	
	}
	...
	public void invokeBrowser() {
		...
		try {
			...
			System.setProperty("webdriver.chrome.driver", "drivers/" + getOS() + "/chromedriver" + getExe());
	...
	public void t4bViewOrderHistory(String orderid) {
		...
		WebElement table = driver.findElement(By.cssSelector("table.table.table-blk"));
	...
	public Object[][] loginDataFeed() {
		...
		ReadExcelFile config = new ReadExcelFile("B2BUSALoginCredentials.xlsx");
